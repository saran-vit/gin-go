...
func main() {
	...
	client := omnisci.NewOmniSciClientFactory(trans, protocolFactory)
	...
	case "krb5_connect":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.Krb5Connect(value0, value1))
		fmt.Print("\n")
		break
	case "disconnect":
		if flag.NArg()-1 != 1 {
	...
	case "switch_database":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.SwitchDatabase(value0, value1))
		fmt.Print("\n")
		break
	case "clone_session":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.CloneSession(value0))
		fmt.Print("\n")
		break
	...
	case "get_hardware_info":
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetHardwareInfo(value0))
		fmt.Print("\n")
		break
	case "get_tables":
		if flag.NArg()-1 != 1 {
	...
	case "get_physical_tables":
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetPhysicalTables(value0))
		fmt.Print("\n")
		break
	case "get_views":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetViews(value0))
		fmt.Print("\n")
		break
	case "get_tables_meta":
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetTablesMeta(value0))
		fmt.Print("\n")
		break
	...
	case "get_internal_table_details":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetInternalTableDetails(value0, value1))
		fmt.Print("\n")
		break
	case "get_users":
		if flag.NArg()-1 != 1 {
	...
	case "get_memory":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetMemory(value0, value1))
		fmt.Print("\n")
		break
	...
	case "set_cur_session":
		...
		value3 := argvalue3
		fmt.Print(client.SetCurSession(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "invalidate_cur_session":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		fmt.Print(client.InvalidateCurSession(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "set_table_epoch":
		...
		value3 := argvalue3
		fmt.Print(client.SetTableEpoch(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "set_table_epoch_by_name":
		...
		argvalue2 := int32(tmp2)
		value2 := argvalue2
		fmt.Print(client.SetTableEpochByName(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_table_epoch":
		...
		argvalue2 := int32(tmp2)
		value2 := argvalue2
		fmt.Print(client.GetTableEpoch(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_table_epoch_by_name":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetTableEpochByName(value0, value1))
		fmt.Print("\n")
		break
	case "get_table_epochs":
		...
		argvalue2 := int32(tmp2)
		value2 := argvalue2
		fmt.Print(client.GetTableEpochs(value0, value1, value2))
		fmt.Print("\n")
		break
	case "set_table_epochs":
		...
		value2 := argvalue2
		fmt.Print(client.SetTableEpochs(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_session_info":
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetSessionInfo(value0))
		fmt.Print("\n")
		break
	case "sql_execute":
		if flag.NArg()-1 != 6 {
		...
		value5 := argvalue5
		fmt.Print(client.SqlExecute(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "sql_execute_df":
		if flag.NArg()-1 != 6 {
		...
		value5 := argvalue5
		fmt.Print(client.SqlExecuteDf(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "sql_execute_gdf":
		...
		argvalue3 := int32(tmp3)
		value3 := argvalue3
		fmt.Print(client.SqlExecuteGdf(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "deallocate_df":
		if flag.NArg()-1 != 4 {
		...
		argvalue3 := int32(tmp3)
		value3 := argvalue3
		fmt.Print(client.DeallocateDf(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "interrupt":
		if flag.NArg()-1 != 2 {
		...
		argvalue1 := flag.Arg(2)
		value1 := omnisci.TSessionId(argvalue1)
		fmt.Print(client.Interrupt(value0, value1))
		fmt.Print("\n")
		break
	case "sql_validate":
		if flag.NArg()-1 != 2 {
	...
	case "get_completion_hints":
		...
		argvalue2 := int32(tmp2)
		value2 := argvalue2
		fmt.Print(client.GetCompletionHints(value0, value1, value2))
		fmt.Print("\n")
		break
	...
	case "get_dashboard":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		fmt.Print(client.GetDashboard(value0, value1))
		fmt.Print("\n")
		break
	case "get_dashboards":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetDashboards(value0))
		fmt.Print("\n")
		break
	case "create_dashboard":
		...
		argvalue4 := flag.Arg(5)
		value4 := argvalue4
		fmt.Print(client.CreateDashboard(value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "replace_dashboard":
		...
		argvalue6 := flag.Arg(7)
		value6 := argvalue6
		fmt.Print(client.ReplaceDashboard(value0, value1, value2, value3, value4, value5, value6))
		fmt.Print("\n")
		break
	case "delete_dashboard":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		fmt.Print(client.DeleteDashboard(value0, value1))
		fmt.Print("\n")
		break
	case "share_dashboards":
		...
		value3 := argvalue3
		fmt.Print(client.ShareDashboards(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "delete_dashboards":
		...
		argvalue1 := containerStruct1.DashboardIds
		value1 := argvalue1
		fmt.Print(client.DeleteDashboards(value0, value1))
		fmt.Print("\n")
		break
	case "share_dashboard":
		...
		value5 := argvalue5
		fmt.Print(client.ShareDashboard(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "unshare_dashboard":
		...
		value4 := argvalue4
		fmt.Print(client.UnshareDashboard(value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "unshare_dashboards":
		...
		value3 := argvalue3
		fmt.Print(client.UnshareDashboards(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "get_dashboard_grantees":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		fmt.Print(client.GetDashboardGrantees(value0, value1))
		fmt.Print("\n")
		break
	case "get_link_view":
		if flag.NArg()-1 != 2 {
	...
	case "load_table_binary":
		...
		value3 := argvalue3
		fmt.Print(client.LoadTableBinary(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "load_table_binary_columnar":
		...
		argvalue3 := containerStruct3.ColumnNames
		value3 := argvalue3
		fmt.Print(client.LoadTableBinaryColumnar(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "load_table_binary_arrow":
		...
		value3 := argvalue3
		fmt.Print(client.LoadTableBinaryArrow(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "load_table":
		if flag.NArg()-1 != 4 {
		...
		argvalue3 := containerStruct3.ColumnNames
		value3 := argvalue3
		fmt.Print(client.LoadTable(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	...
	case "create_table":
		...
		value4 := argvalue4
		fmt.Print(client.CreateTable(value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "import_table":
		if flag.NArg()-1 != 4 {
	...
	case "import_geo_table":
		...
		value5 := argvalue5
		fmt.Print(client.ImportGeoTable(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	...
	case "get_first_geo_file_in_archive":
		...
		value2 := argvalue2
		fmt.Print(client.GetFirstGeoFileInArchive(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_all_files_in_archive":
		...
		value2 := argvalue2
		fmt.Print(client.GetAllFilesInArchive(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_layers_in_geo_file":
		...
		value2 := argvalue2
		fmt.Print(client.GetLayersInGeoFile(value0, value1, value2))
		fmt.Print("\n")
		break
	case "query_get_outer_fragment_count":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.QueryGetOuterFragmentCount(value0, value1))
		fmt.Print("\n")
		break
	case "check_table_consistency":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		fmt.Print(client.CheckTableConsistency(value0, value1))
		fmt.Print("\n")
		break
	case "start_query":
		if flag.NArg()-1 != 6 {
		...
		value5 := argvalue5
		fmt.Print(client.StartQuery(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "execute_query_step":
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		fmt.Print(client.ExecuteQueryStep(value0, value1, value2))
		fmt.Print("\n")
		break
	case "broadcast_serialized_rows":
		...
		argvalue0 := omnisci.NewTSerializedRows()
		...
		argvalue4 := flag.Arg(5) == "true"
		value4 := argvalue4
		fmt.Print(client.BroadcastSerializedRows(value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "start_render_query":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		fmt.Print(client.StartRenderQuery(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "execute_next_render_step":
		...
		fmt.Print(client.ExecuteNextRenderStep(value0, value1))
		fmt.Print("\n")
		break
	case "insert_data":
		if flag.NArg()-1 != 2 {
	...
	case "checkpoint":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		fmt.Print(client.Checkpoint(value0, value1))
		fmt.Print("\n")
		break
	case "get_roles":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetRoles(value0))
		fmt.Print("\n")
		break
	case "get_db_objects_for_grantee":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetDbObjectsForGrantee(value0, value1))
		fmt.Print("\n")
		break
	case "get_db_object_privs":
		...
		value2 := argvalue2
		fmt.Print(client.GetDbObjectPrivs(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_all_roles_for_user":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetAllRolesForUser(value0, value1))
		fmt.Print("\n")
		break
	case "has_role":
		if flag.NArg()-1 != 3 {
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		fmt.Print(client.HasRole(value0, value1, value2))
		fmt.Print("\n")
		break
	case "has_object_privilege":
		...
		value4 := argvalue4
		fmt.Print(client.HasObjectPrivilege(value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "set_license_key":
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		fmt.Print(client.SetLicenseKey(value0, value1, value2))
		fmt.Print("\n")
		break
	case "get_license_claims":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.GetLicenseClaims(value0, value1))
		fmt.Print("\n")
		break
	case "get_device_parameters":
		...
		argvalue0 := flag.Arg(1)
		value0 := omnisci.TSessionId(argvalue0)
		fmt.Print(client.GetDeviceParameters(value0))
		fmt.Print("\n")
		break
	case "register_runtime_extension_functions":
		...
		value3 := argvalue3
		fmt.Print(client.RegisterRuntimeExtensionFunctions(value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "":
		Usage()
