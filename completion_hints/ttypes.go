...
func (p TCompletionHintType) String() string {
	switch p {
	case TCompletionHintType_COLUMN:
		return "COLUMN"
	case TCompletionHintType_TABLE:
		return "TABLE"
	case TCompletionHintType_VIEW:
		return "VIEW"
	case TCompletionHintType_SCHEMA:
		return "SCHEMA"
	case TCompletionHintType_CATALOG:
		return "CATALOG"
	case TCompletionHintType_REPOSITORY:
		return "REPOSITORY"
	case TCompletionHintType_FUNCTION:
		return "FUNCTION"
	case TCompletionHintType_KEYWORD:
		return "KEYWORD"
	}
	return "<UNSET>"
}
...
func TCompletionHintTypeFromString(s string) (TCompletionHintType, error) {
	switch s {
	case "COLUMN":
		return TCompletionHintType_COLUMN, nil
	case "TABLE":
		return TCompletionHintType_TABLE, nil
	case "VIEW":
		return TCompletionHintType_VIEW, nil
	case "SCHEMA":
		return TCompletionHintType_SCHEMA, nil
	case "CATALOG":
		return TCompletionHintType_CATALOG, nil
	case "REPOSITORY":
		return TCompletionHintType_REPOSITORY, nil
	case "FUNCTION":
		return TCompletionHintType_FUNCTION, nil
	case "KEYWORD":
		return TCompletionHintType_KEYWORD, nil
	}
...
type TCompletionHint struct {
	Type     TCompletionHintType `thrift:"type,1" json:"type"`
	Hints    []string            `thrift:"hints,2" json:"hints"`
	Replaced string              `thrift:"replaced,3" json:"replaced"`
}
